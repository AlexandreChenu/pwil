...
for i in range(1,2):
	...
	with open('./demonstrations/humanoid_standup_env/' + str(i) + '.demo', 'rb') as handle:
	...
	print("len(new_demo) = ", len(new_demo))

	L_demo.append(new_demo)
	print("len(L_demo) = ", len(L_demo))

print(len(L_demo))


with open('./demonstrations/humanoid_standup_env/HumanoidStandupEnv-v0.pkl', 'wb') as handle:
